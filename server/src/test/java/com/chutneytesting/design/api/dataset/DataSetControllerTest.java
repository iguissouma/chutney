...
public class DataSetControllerTest {
    ...
    private DataSetRepository dataSetRepository = mock(DataSetRepository.class);
    ...
    @ParameterizedTest
    @ValueSource(strings = {DataSetController.BASE_URL + "/%s/%s", DataSetController.BASE_URL + "/%s/versions/%s"})
